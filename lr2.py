...
def run_get_scale(run, scale):
    ...
    rPr.append(w_elem)
my_encoding = 'windows-1251'
my_text = 'Без труда и палку не выстругаешь.'
bit_line = ''.join(format(byte, '08b') for byte in my_text.encode(my_encoding))

doc = docx.Document('4.docx')
...
print('Масштаб некоторых элементов изменен на 99')

doc.save('q4.docx')
print('Текст сохранен в q4.docx')
